...
const CustomTheme = {
  ...
  registerThemeEditorEvents() {
    document.addEventListener('shopify:section:load', (event) => {
      ...
      const section = document.querySelector(`#shopify-section-${event.detail.sectionId}`);
      if (section) {
        section.querySelectorAll('custom-tabs, custom-filter-tabs').forEach((tabs) => {
          tabs._initialized = false;
          if (typeof tabs.connectedCallback === 'function') {
